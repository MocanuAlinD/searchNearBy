    ...
    <Container className={styles.donatii}>
      ...
      <ol>
        <li>
          ...
          capacității noastre de stocare și gestionare a datelor, asigurându-ne
          că informațiile rămân accesibile și fiabile.
        </li>
        <li>
          <span>Dezvoltare continuă:</span> Continuăm să adăugăm noi
          funcționalități și să îmbunătățim experiența utilizatorilor. Sprijinul
          vostru ne permite să investim în echipă și în dezvoltare tehnologică.
        </li>
        <li>
          <span>Securitate sporită:</span> Păstrăm datele utilizatorilor în
          siguranță, iar donațiile ne ajută să implementăm măsuri de securitate
          și protecție pentru a vă asigura că sunteți în deplină siguranță.
        </li>
        <li>
          <span>Servicii fără publicitate:</span> Am decis să nu afișăm
          publicitate pentru a vă oferi o experiență mai curată și mai plăcută.
          Donațiile ne ajută să compensăm aceste pierderi.
        </li>
      </ol>
      <p className={styles.para}>
        Fiecare donație, indiferent de mărime, face o diferență semnificativă.
        Vă rugăm să vă gândiți să sprijiniți platforma noastră pentru a continua
        să oferim servicii de calitate superioară și pentru a susține
        comunitatea noastră. Vă mulțumim din inimă pentru generozitatea voastră
        și pentru că sunteți alături de noi în această călătorie. Cu sprijinul
        vostru, suntem hotărâți să facem platforma noastră și mai bună și mai
        utilă pentru toți utilizatorii noștri.
      </p>
